...
ENV BUILD_PACKAGES autoconf automake build-essential libtool unzip curl
ENV RUNTIME_PACKAGES libunwind8 gettext libssl-dev libcurl3-dev zlib1g libc-dev
